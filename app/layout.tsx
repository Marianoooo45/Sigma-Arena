  ...
  return (
    <html lang="en">
      <body className="min-h-screen relative bg-[var(--gx-bg)] text-[var(--gx-text)]">
        ...
        <a href="#main" className="sr-only focus:not-sr-only fixed left-3 top-3 z-[var(--z-max)] btn btn-primary">
          Skip to content
        </a>
        <TopBar />
        <HUD />
        <main id="main" className="container py-6 md:py-8 relative z-[var(--z-content)]">
          {children}
        </main>
