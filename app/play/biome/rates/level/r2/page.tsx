// app/play/biome/rates/level/r2/page.tsx
"use client";
...
export default function RatesLevelR2() {
  ...
  useEffect(() => {
    setLoading(true);
    fetchQuestionSet("rates", "r2", true)
      .then((qs) => {
  ...
  function finishLevel() {
    ...
    if (pass) {
      try { Progress.markCleared("rates", "r2"); } catch {}
    }
    // Ping UI
  ...
  const headerTitle = "RATES • LEVEL 2";
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-extrabold tracking-wide" style={{ color: theme.glow }}>LEVEL 2 • RATES</div>
            <div className="text-[13px] text-[var(--gx-muted)]">Carry & roll • convexity</div>
          </div>
        </div>
        <div
